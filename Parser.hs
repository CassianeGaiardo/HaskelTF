...
happyExpList = Happy_Data_Array.listArray (0,163) ([6624,8200,0,0,57344,3993,0,0,0,6624,8,16,0,57344,2073,39392,31,32,39904,15,0,6624,57352,2073,6624,57352,2073,32768,3,384,0,0,256,6624,8,24576,0,0,64,0,0,0,40416,57359,2073,6624,104,0,0,0,0,0,96,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Exp","Type","num","true","false","if","then","else","lambda","ident","':'","\"->\"","'+'","'*'","\"&&\"","\"||\"","'('","')'","TBool","TNum","%eof"]
...
action_12 (10) = happyShift action_22
...
action_34 (5) = happyGoto action_32
